        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    planLocation = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Userplans_Plans_PlansID",
                        column: x => x.PlansID,
                        principalTable: "Plans",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Userplans_Userinfo_UserinfoID",
                        column: x => x.UserinfoID,
                        principalTable: "Userinfo",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Userplans_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Userplans_PlansID",
                table: "Userplans",
                column: "PlansID");

            migrationBuilder.CreateIndex(
                name: "IX_Userplans_UserinfoID",
                table: "Userplans",
                column: "UserinfoID");

            migrationBuilder.CreateIndex(
                name: "IX_Userplans_UsersId",
                table: "Userplans",
                column: "UsersId");
        }
